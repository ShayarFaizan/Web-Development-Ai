...
function OrderSuccessContent() {
  ...
  const delivery = searchParams.get("delivery") || "13–21 days";
      ...
      <div className="max-w-md w-full bg-white p-8 rounded-xl shadow-lg border border-gray-100 mt-[70px]">
        <div className="text-center">
          ...
          <p className="text-sm text-gray-500 mb-8">
            Thank you for your order! Our team will start working on your
            project shortly.
          </p>
          ...
          <div className="bg-gray-50 rounded-lg p-5 text-left space-y-3 mb-8 border border-gray-100">
            <div className="flex justify-between items-center pb-3 border-b border-gray-200">
              ...
              <span
                className="text-sm font-bold text-gray-900 truncate max-w-[150px]"
                title={orderId}
              >
                {orderId}
              </span>
            ...
            <div className="flex justify-between items-center pb-3 border-b border-gray-200">
              ...
              <span
                className="text-sm font-bold text-gray-900 truncate max-w-[150px] text-right"
                title={service}
              >
                {service}
              </span>
